...
from rg_nanogpt_one_head.evaluation import evaluate_bleu, evaluate_probe

from .completion import CompletedRunValidationError, validate_completed_run
from .config import expected_matrix_count, tokens_per_step
...
EPOCH_FIELDS = [*METRIC_FIELDS, "nominal_epoch", "checkpoint_path", "test_monitoring_only"]
...
def write_manifest(
    ...
    *,
    ...
    payload = {
        ...
        "transformer_matrix_count": expected_matrix_count(cfg),
        ...
        "bleu_policy": "fixed greedy held-out continuation BLEU; secondary diagnostic",
    }
...
def checkpoint_eval(
    ...
    *,
    ...
    bleu = evaluate_bleu(model, bleu_probe, device=device, batch_size=bleu_batch_size)
    return {
