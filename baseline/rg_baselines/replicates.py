...
def run_baseline_replicates(
    ...
    *,
    ...
    Each seed is a complete training run, including a WeightWatcher checkpoint
    at epoch zero and after every epoch.  Error bars are therefore across
    independent optimizer trajectories, not across minibatches.
    """
